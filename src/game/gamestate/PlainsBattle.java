...
public class PlainsBattle extends BaseLevel{

	public PlainsBattle(GameStateManager gsm) {
		super(gsm);
	}
	...
	public void init() {
		...
		for(int i = 0; i < 3; i++) {
			if(Math.random() * 10 > 5) mob[i] = new Pig(i, this);
			else mob[i] = new Bunny(i, this);
		}
